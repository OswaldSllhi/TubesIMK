...
export default function AnggotaRolesIndex() {
  //title page
  document.title = "Categories - Desa Digital";

  //define state "categories"
  const [categories, setAnggotaRoles] = useState([]);
  ...
  //function "deleteAnggotaRoles"
  const deleteAnggotaRoles = (id) => {
    //show confirm alert
    confirmAlert({
      title: "Are You Sure ?",
                    ...
                    <table className="table table-bordered table-centered mb-0 rounded">
                      <thead className="thead-dark">
                        <tr className="border-0">
                          ...
                          <th className="border-0">AnggotaRoles Name</th>
                      ...
                      <tbody>
                        {
                          ...
                          categories.length > 0 ? (
                            ...
                            categories.map((anggotaroles, index) => (
                              <tr key={index}>
                                ...
                                <td>{anggotaroles.name}</td>
                                <td className="text-center">
                                  {hasAnyPermission(["categories.edit"]) && (
                                    <Link
                                      to={`/admin/categories/edit/${anggotaroles.id}`}
                                  ...
                                  {hasAnyPermission(["categories.delete"]) && (
                                    <button
                                      onClick={() =>
                                        deleteAnggotaRoles(anggotaroles.id)
                                      }
