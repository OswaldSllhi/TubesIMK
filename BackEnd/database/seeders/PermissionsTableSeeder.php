...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //permission for konselor
        Permission::create(['name' => 'konselor.index', 'guard_name' => 'api']);
        Permission::create(['name' => 'konselor.create', 'guard_name' => 'api']);
        Permission::create(['name' => 'konselor.edit', 'guard_name' => 'api']);
        Permission::create(['name' => 'konselor.delete', 'guard_name' => 'api']);
    }
}