...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        //Konselors
        Route::apiResource('/konselors', App\Http\Controllers\Api\Admin\KonselorController::class)
            ->middleware('permission:konselor.index|konselor.store|konselor.update|konselor.delete');
    });
});
...
Route::prefix('public')->group(function () {
    ...
    Route::get('/konselor', [App\Http\Controllers\Api\Public\KonselorController::class, 'index']);
    ...
    Route::get('/public/posts/search', [PostController::class, 'searchByTitle']);
});